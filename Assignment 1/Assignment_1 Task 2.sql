...
VALUES ('Alex', 'Parker', 'alex.parker@email.com', '9876543210', '789 Elm Street');

--SQL query to update the prices of all electronic gadgets in the "Products" table by increasing them by 10%--
UPDATE Products
SET Price = Price * 1.10
WHERE ProductName IN ('Laptop', 'Smartphone', 'Tablet', 'Smartwatch', 'Monitor', 'Keyboard', 'Mouse', 'Printer', 'Router');
